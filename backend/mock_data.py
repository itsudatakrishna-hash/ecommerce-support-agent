orders = {
    ...
    "1067": {
        ...
        "status": "cancelled", "date": "2026-06-05", "estimatedDelivery": None,
...
_tickets = [
    {
        "id": "TK-9821", "customerId": "C-9934", "customer": "Priya Nair",
        "issue": "Order #1055 delayed shipment", "priority": "high",
        "status": "open", "created": "2026-06-09 09:21", "assignee": "Logistics Team",
    },
    {
        "id": "TK-9814", "customerId": "C-8821", "customer": "Sarah Mitchell",
        "issue": "Wrong item delivered in order #1041", "priority": "medium",
        "status": "in_progress", "created": "2026-06-08 14:33", "assignee": "Support Agent L2",
    },
    {
        "id": "TK-9800", "customerId": "C-5510", "customer": "James Thornton",
        "issue": "iPad screen defect — return initiated", "priority": "low",
        "status": "resolved", "created": "2026-06-07 10:12", "assignee": "Returns Team",
    },
]
...
# In-memory mutable state for agent-created records
live_tickets = list(_tickets)
live_refunds: list = []
live_conversations = list(_conversations)
